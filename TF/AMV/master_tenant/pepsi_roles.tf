resource "hpe_morpheus_role" "pepsi_tenant_role" {
  name        = "Pepsi Tenant Admin Role"
  description = "Pepsi Tenant Admin Role"
  role_type   = "tenant"
...
resource "hpe_morpheus_role" "pepsi_admin_role" {
  name        = "Pepsi Admin Role"
  multitenant = true
  description = "Pepsi Admin Role"
  role_type   = "user"
  provider    = hpe.master-tenant
  permissions = {
    default_instance_type_access = "full"
...
resource "hpe_morpheus_role" "pepsi_user_role" {
  name        = "Pepsi User Role"
  multitenant = true 
  description = "Pepsi User Role"
  role_type   = "user"
  provider    = hpe.master-tenant
  permissions = {
    default_group_access = "full"
